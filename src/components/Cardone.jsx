  ...
  return (
      <div className="card" >
        ...
        <div>
          ...
          <p className="cancel"><i className="bi bi-x cancel"></i> {props.rowFive}</p>
          <p className="cancel"><i className="bi bi-x cancel"></i> {props.rowSix}</p>
          <p className="cancel"><i className="bi bi-x cancel"></i> {props.rowSeven}</p>
